module MovieRating
  ...
  module ClassMethods
    ...
    def create_new_movie(id, params)
      ...
      Movie.new(id: id, title: title, poster_path: params[:poster_path], media_type: params[:media_type], release_date: params[:release_date], description: description, vote_count: params[:vote_count], vote_rating: params[:vote_rating])
    end

    def existing_movie_rated(id, params, user)
      movie = Movie.find(id)
