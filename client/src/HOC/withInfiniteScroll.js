...
function withInfiniteScroll(Component) {
    return class extends Component {
        ...
        componentDidMount() {
            ...
            /* if navigating back from a movie/:id page, this code prevents a new api fetch call and 
      instead reloads the page with the existing props from before; the page !== 0 conditional ensures
      the component does mount at least once (a page value of greater than 1 guarantess there was previous activity) */
            if (
