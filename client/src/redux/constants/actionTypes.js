...
export const CAST_REQUESTING = "CAST_REQUESTING";
export const CAST_SUCCESS = "CAST_SUCCESS";
export const MOVIES_ERROR = "MOVIES_ERROR";
export const FILTER_MOVIE_RATINGS = "FILTER_MOVIE_RATINGS";
...
export const RATING_REMOVE_REQUESTING = "RATING_REMOVE_REQUESTING";
export const RATING_REMOVE_SUCCESS = "RATING_REMOVE_SUCCESS";
